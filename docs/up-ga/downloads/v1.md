...
<div class="tile-1" style="text-align:center; color:black">
  Total downloads, as determined by Google Analytics. To count multiple downloads of the same file by the same user, there must be a gap of at least 30 minutes from the last download, even if that previous download was not counted. NOTE: A view that occurs 2 hours after the first download will not be counted. See the last entry in the table below; it should be counted because it is 30 minutes after the last download, but because it is 2 hours after the first download, it is not counted.
</div>
