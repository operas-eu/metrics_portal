...
Total views of the landing page of a work, as determined by Google Analytics. To count multiple views of the same landing page by the same user, there must be a gap of at least 30 minutes from the last view of that landing page, even if that previous view was not counted.
</div>
